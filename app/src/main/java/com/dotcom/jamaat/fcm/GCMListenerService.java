...
import com.dotcom.jamaat.activity.Common.NotificationActivity;
	...
	public void onMessageReceived(RemoteMessage message){
		...
		try {
			if (IANappApplication.getInstance().isBackGround()) {
				...
				LocalBroadcastManager.getInstance(this).sendBroadcast(new Intent(Constants.BROADCAST_ACTION_NOTIFICATION_RECIEVED));
			}
		}catch(Exception e){
			e.printStackTrace();
		}
